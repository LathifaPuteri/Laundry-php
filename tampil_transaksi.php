                                    ...
                                    <table class="table">
                                        ...
                                        <?php  while($data=mysqli_fetch_array($result)){?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="ubah_transaksi.php?id_transaksi=<?php echo $data['id_transaksi']?>"><button class="btn btn-primary px-2">Edit</button></a>
                                                ...
                                                <td><a href="tampil_detail_transaksi.php?id_transaksi=<?php echo $data['id_transaksi']?>"><button class="btn btn-primary px-2">Detail</button></a></td>
                                                <td><a target="_blank" href="cetak.php?id_transaksi=<?php echo $data['id_transaksi']?>"><button class="btn btn-primary px-2">Print</button></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
