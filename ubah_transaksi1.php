                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="proses_ubah_transaksi1.php" method="post">
                                    <input name="id_transaksi" type="hidden" value="<?=$data['id_transaksi']?>">
                                    <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="member">Member <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" class="form-control" id="tgl" name="tgl" placeholder="Enter a name.." value="<?=$data['tgl']?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" class="form-control" id="batas_waktu" name="batas_waktu" placeholder="Enter a name.." value="<?=$data['batas_waktu']?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" class="form-control" id="tgl_bayar" name="tgl_bayar" placeholder="Enter a name.." value="<?=$data['tgl_bayar']?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="user"> User <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
